...
Summary(pl.UTF-8):   kavi2svcd - GUI do generowania plików MPEG z plików AVI
Name:		kavi2svcd
Version:	0.8.7
Release:	1
License:	GPL v2
...
kavi2svcd to GUI do generowania plików MPEG z plików AVI przy użyciu
narzędzi transcode i mplex. Generuje także obrazy Video CD przy użyciu
vcdimagera i wypala na CD przy użyciu cdrdao. Może także generować
pliki m1v, m2v i mpa, przeplatać plik MPEG, generować pliki cue i bin,
a także pozwala na modyfikowanie wygenerowanych linii poleceń przed
ich wykonaniem.
